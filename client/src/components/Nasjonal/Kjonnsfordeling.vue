                ...
                <div class="as-margin-auto as-margin-left-none">
                    <h4>
                        <template v-if="selectedYears.length > 1">
                            {{ statNavn }} kjønnsfordeling fra {{ selectedYears[0] }} til {{ selectedYears[selectedYears.length-1] }}
                        </template>
                        <template v-else>
                            {{ statNavn }} kjønnsfordeling for {{ selectedYears[0] }}
                        </template>
                    </h4>
                </div>
    ...
    methods: {
        async init() {
            ...
            const data = {
                ...
                controller: 'nasjonalt/kjonnsfordeling',
                season: year,
            };
